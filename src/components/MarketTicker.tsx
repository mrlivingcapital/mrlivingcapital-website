  ...
  const content = (
    <>
      {tickerItems.map((item, i) => (
        ...
        >
          <span style={{ color: '#5A7A72', fontSize: 11, fontFamily: 'Inter, sans-serif' }}>{item.label}</span>
          <span style={{ color: '#E8DDD0', fontSize: 12, fontWeight: 500, fontFamily: 'Space Grotesk, sans-serif' }}>{item.value}</span>
          <span
            style={{
