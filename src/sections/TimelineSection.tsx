        ...
        <div style={{ position: 'relative' }}>
          ...
          <div
            style={{
              ...
              bottom: 0,
              width: 2,
              background: 'linear-gradient(180deg, #0F6B62, #7D8A86)',
              ...
              >
                ...
                >
                  <div
                    ...
                    style={{
                      padding: '24px',
                      cursor: 'pointer',
                      border: activeStep === i ? '1px solid rgba(15, 107, 98, 0.4)' : undefined,
                    }}
                    onClick={() => setActiveStep(i)}
                  >
                    <div className="font-caption" style={{ color: '#0F6B62', fontSize: 11, marginBottom: 6 }}>
                      {step.month}
                    </div>
                ...
                <div
                  style={{
                    ...
                    height: 44,
                    borderRadius: '50%',
                    background: activeStep === i ? 'rgba(15, 107, 98, 0.2)' : 'rgba(125, 138, 134, 0.1)',
                    border: activeStep === i ? '2px solid #0F6B62' : '1.5px solid rgba(125, 138, 134, 0.3)',
                    display: 'flex',
                    alignItems: 'center',
