    ...
    >
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        >
          {/* Brand */}
          <div>
            <div className="font-nav" style={{ color: 'rgba(246, 241, 231, 0.92)', fontSize: 16, marginBottom: 8, letterSpacing: '0.1em' }}>
              MR LIVING CAPITAL
            </div>
            <p className="font-body" style={{ color: 'rgba(246, 241, 231, 0.62)', fontSize: 14, lineHeight: 1.6 }}>
          ...
          {/* Quick Links */}
          <div>
            <div className="font-caption" style={{ color: '#57A99F', marginBottom: 16, fontSize: 11 }}>QUICK LINKS</div>
            {['Market Data', 'Corridors', 'Intelligence', 'Contact'].map((link) => (
              <a
                ...
                onMouseEnter={(e) => (e.currentTarget.style.color = '#57A99F')}
                onMouseLeave={(e) => (e.currentTarget.style.color = 'rgba(246, 241, 231, 0.62)')}
              >
                {link}
              </a>
            ))}
          ...
          {/* Connect */}
          <div>
            <div className="font-caption" style={{ color: '#57A99F', marginBottom: 16, fontSize: 11 }}>CONNECT</div>
            <a
              href="mailto:Masoud@mrlivingcapital.com"
              className="font-body block"
              style={{ color: '#57A99F', fontSize: 14, textDecoration: 'none', marginBottom: 8, transition: 'color 0.3s ease' }}
              onMouseEnter={(e) => (e.currentTarget.style.color = '#57A99F')}
              onMouseLeave={(e) => (e.currentTarget.style.color = '#57A99F')}
            >
            ...
            <div style={{ display: 'flex', gap: 16, marginTop: 12 }}>
              {socials.map((s) => (
                <a
                  ...
                  style={{ color: 'rgba(246, 241, 231, 0.62)', fontSize: 11, textDecoration: 'none', transition: 'color 0.3s ease' }}
                  onMouseEnter={(e) => (e.currentTarget.style.color = '#57A99F')}
                  onMouseLeave={(e) => (e.currentTarget.style.color = 'rgba(246, 241, 231, 0.62)')}
                >
                  {s.label}
