...
const corridorData: Record<string, CorridorResult[]> = {
  'Apartment': [
    { name: 'Dubai South', entryPrice: 800, yield: 7.5, appreciation: 25, match: 95 },
    { name: 'JVC', entryPrice: 1142, yield: 7.5, appreciation: 20, match: 92 },
    { name: 'MBRC', entryPrice: 2000, yield: 6.7, appreciation: 18, match: 78 },
    { name: 'Meydan', entryPrice: 2800, yield: 6.0, appreciation: 22, match: 65 },
  ],
  'Villa': [
    { name: 'Dubai South', entryPrice: 600, yield: 6.5, appreciation: 22, match: 88 },
    { name: 'JVC', entryPrice: 950, yield: 7.0, appreciation: 18, match: 85 },
    { name: 'MBRC', entryPrice: 1800, yield: 6.5, appreciation: 25, match: 98 },
    { name: 'Meydan', entryPrice: 2500, yield: 5.5, appreciation: 28, match: 90 },
  ],
  'Townhouse': [
    { name: 'Dubai South', entryPrice: 700, yield: 7.0, appreciation: 24, match: 92 },
    { name: 'JVC', entryPrice: 1000, yield: 7.2, appreciation: 19, match: 88 },
    { name: 'MBRC', entryPrice: 1900, yield: 6.3, appreciation: 22, match: 85 },
    { name: 'Meydan', entryPrice: 2600, yield: 5.8, appreciation: 26, match: 82 },
  ],
  'Off-Plan': [
    { name: 'Dubai South', entryPrice: 750, yield: 8.0, appreciation: 30, match: 96 },
    { name: 'JVC', entryPrice: 1050, yield: 8.0, appreciation: 25, match: 94 },
    { name: 'MBRC', entryPrice: 1700, yield: 7.2, appreciation: 28, match: 92 },
    { name: 'Meydan', entryPrice: 2400, yield: 6.5, appreciation: 32, match: 88 },
  ],
}
