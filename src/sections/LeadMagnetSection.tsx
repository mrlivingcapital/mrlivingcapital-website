                ...
                <div style={{ display: 'flex', gap: 40, alignItems: 'center', flexWrap: 'wrap' }}>
                  ...
                  <div style={{ flex: 1, minWidth: 260 }}>
                    ...
                    <p className="font-body" style={{ color: 'rgba(232, 221, 208, 0.5)', fontSize: 13, marginBottom: 20 }}>
                      {reportType === 'q1'
                        ? 'Verified DLD data. Investment corridor analysis. Price per sqft breakdowns.'
                        : 'Negotiating below market value. Price per sqft analysis. Highest leverage corridors.'}
                    </p>
