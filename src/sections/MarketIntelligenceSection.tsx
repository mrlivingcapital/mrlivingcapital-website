        ...
        <ScrollReveal>
          <div style={{ textAlign: 'center', marginBottom: 64 }}>
            ...
            <h2 className="font-heading" style={{ fontSize: 'clamp(28px, 4vw, 56px)', color: '#E8DDD0', marginBottom: 16 }}>
              THE NUMBERS BEHIND <span style={{ color: '#C9A87C' }}>DUBAI 2026</span>
            </h2>
            <p className="font-body" style={{ color: 'rgba(232, 221, 208, 0.6)', fontSize: 16, maxWidth: 640, margin: '0 auto' }}>
              Off-plan properties now dominate 70–73% of all transactions. This isn't a trend — it's a structural market shift driven by payment plans, Golden Visa, and developer incentives.
            </p>
          </div>
        </ScrollReveal>
