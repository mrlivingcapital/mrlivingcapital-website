...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    subtitle: 'Dubai 2026 Investment Guide for Farsi-speaking investors. Golden Visa, corridors, and negotiation strategies.',
    geo: 'FARSI',
        ...
        <ScrollReveal>
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <h2 className="font-heading" style={{ fontSize: 'clamp(28px, 4vw, 48px)', color: '#E8DDD0', marginBottom: 12 }}>
              REGIONAL <span style={{ color: '#C9A87C' }}>MARKET REPORTS</span>
            </h2>
            <p className="font-body" style={{ color: 'rgba(232, 221, 208, 0.5)', fontSize: 15, maxWidth: 560, margin: '0 auto' }}>
              Geo-specific investment analysis for investors in Dubai, London, Toronto, the Balkans, and Farsi-speaking regions worldwide.
            </p>
          </div>
        </ScrollReveal>
